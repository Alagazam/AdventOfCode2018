...
TEST(Day04, Day04_A_1_trivial) {
	...
	auto	input = aoc2018::ReadInput(ss);
	EXPECT_EQ(10*5, aoc2018_04::getBestGuard(input).first);
}
...
TEST(Day04, Day04_A_1) {
	...
	auto	input = aoc2018::ReadInput(ss);
	EXPECT_EQ(240, aoc2018_04::getBestGuard(input).first);
}


TEST(Day04, Day04_B_1) {
	std::istringstream ss(
		"[1518-11-01 00:00] Guard #10 begins shift\n"
		"[1518-11-01 00:05] falls asleep\n"
		"[1518-11-01 00:55] wakes up\n"
		...
		"[1518-11-05 00:55] wakes up\n");
	auto	input = aoc2018::ReadInput(ss);
	EXPECT_EQ(4455, aoc2018_04::getBestGuard(input).second);
}
